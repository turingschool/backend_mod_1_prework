...
save_the_day = "Nothing good is born from lies, and greatness is not what you think."
bad_excuse = "Oh, I don't think it's my turn.  Next hero please."
...
scary_monster = {
  ...
  address: {number: "777", street: "Bangluha", state: "No Where", zip: 66666}
}
...
wonder_woman = SuperHero.new("Wonder Woman", "Hand to hand combat", 5000, @arch_nemesis, @power_level, @energy_level)
p wonder_woman.name
p wonder_woman.arch_nemesis
p wonder_woman.power_level
p wonder_woman.energy_level
...
iron_man = SuperHero.new("Iron Man", "advanced technology", 45, @arch_nemesis, @power_level, @energy_level)
p iron_man.say_name
p iron_man.maximize_enery
p iron_man.gain_power(30)

superman = SuperHero.new("Superman", "superpowers", 40, @arch_nemesis, @power_level, @energy_level)
p superman.say_name
p superman.maximize_enery
p superman.gain_power(67)
...
# -- In order to be excellent at anything, practice is key.  Hence, I will
# basically be practicing at everything and focus more on the parts
