...
puts "Hens #{25.0 + 30 / 6}"
#output string with string interpolation and an example of modulus
...
# boolean evaluation inside string interpolation
puts "Is it greater? #{5.0 > -2}"
# more boolean inside string interpolation
