...
marvel_movie = "Civil War"
favorite_character = "Spider-Man"
times_watched = 10

p "My favorite Marvel movie is #{marvel_movie} because it has #{favorite_character}. I've seen it probably #{times_watched} times."
