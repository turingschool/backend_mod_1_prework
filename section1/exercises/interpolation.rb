...
call_out = "TORO! "
repetion_required = 3
descriptive_types = ["Monkeys", "Matadors", "Mayhem"]

p "#{call_out * repetion_required}they cry! In a #{repetion_required} star production filled with #{descriptive_types.join(", ")}! Fun for all!"
