...
# Think carefully about what you name the variables. Remember,
# the goal is to be concise but descriptive (it's a hard balance!)
# Then, log out ONE sentence that incorporates all THREE variables.
name = "Bob"
age = 89
fav_activity = "poker"

p "#{name}, who is #{age} years old, loves to play #{fav_activity}."
