...
# Think carefully about what you name the variables. Remember, the goal is to
# be concise but descriptive (it's a hard balance!) Then, log out ONE sentence
# that incorporates all THREE variables.

sandwich = "BLT"
bread = "sourdough"
extra_ingredients = "mayo, pepper, and pickles!"

puts "I want a #{sandwich} with a #{bread} bun - Don't forget the #{extra_ingredients}"
