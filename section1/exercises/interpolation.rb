...
plant_type = "Calatheas"
care_requirements = "bright light and moisture"
best_feature = "gorgeous leaves"
p "#{plant_type} need #{care_requirements} to produce their #{best_feature}."
