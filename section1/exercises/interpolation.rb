...
career1 = "paleontologist"
career2 = "soldier"
career3 = "personal trainer"

p "When I was young, I wanted to be a #{career1}. Later on, I changed my mind and wanted to become a #{career2}. Much later, I eventually decided to be a #{career3}. Guess what happened next!"
