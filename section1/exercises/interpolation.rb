...
# all THREE variables.
pp_market_food = "Piroshky Piroshky"
pp_market_brewery = "Old Stove Brewing"
pp_market_coffee = "Storyville"

p "Vist Seattle's Pike Place Market and enjoy food from #{pp_market_food}, beer from #{pp_market_brewery} and coffee from #{pp_market_coffee}."
