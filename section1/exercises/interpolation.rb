...
# "When the summer is hot, it's nice to throw some BBQ on the grill!"
temperature = "hot"
favorite_food = "BBQ"
outdoor_equipment = "grill"

p "When the summer is #{temperature}, it's nice to throw some #{favorite_food} on the #{outdoor_equipment}!"
