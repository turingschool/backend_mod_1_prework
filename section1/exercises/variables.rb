...
# Explain.
# first_name is a string which represents a string of charactrers, is_hungry is a boolean
# because it's logical and number_of_pets states its a number so Integer
