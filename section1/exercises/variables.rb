...
# I determined that the output result for first_name would be a string because a name is a collection of letters.
# is_hungry is a true or false statement and is therefore a boolean.
# Number_of_pets is asking for a numberic value so I assigned it an integer (since I don't have a floating number of pets).
