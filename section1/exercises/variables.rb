...
# Explain.
# I used strings on the first two variables and an integer on the 3rd bc it was a number not a word.
...
# Did you run this file in your terminal to make sure everything printed out to the terminal
  # as you would expect?
  # all turned out correct in terminal other than total number of snacks, had to redo.
