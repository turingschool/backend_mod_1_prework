...
# first_name is asking for a string input such as a name. is_hungry is a boolean type variable, since it can be answered true or false.
#number_of_pets is an integer variable, since someone can't have half a pet. Or doesn't want to.
