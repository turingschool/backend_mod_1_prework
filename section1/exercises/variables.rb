...
puts "Is #{first_name} hungry after walking her #{number_of_pets} dog? #{is_hungry}!"
# IN WORDS:
# How did you decide to use the data type you did for each of the three variables above?

# Explain.
#first_name I chose to use a string for the data type since it was.
#is_hungry I chose to use a boolean data type since it could be answered with a true or false.
#number_of_pets I chose to use an integer since it couldn't be a fraction of a number.
