...
house_elf_message = "#{name} must not return to Hogwarts!"

# Write code that adds 2 to the `students` variable and
# prints the result:
students = 22
students_add = students + 2
p students_add

# Write code that subracts 2 from the `students` variable and
# prints the result:
students_sub = students - 2
p students_sub
...
# I decided to use a string, boolean, and number to practice using different
# data types. Each variable was nicely selected so I could do this.
