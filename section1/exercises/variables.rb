...
# Explain.
# I used a string for first_name because it is text.
# I used booleans for is_hungry becuase it is binary (either true or false).
# I used numbers for number_of_pets because it is a number.
