...
# When I write the statement below I get the error listed further under that. I'm not sure why it is not working.
...
#if_statements.rb:70: warning: found `= literal' in conditional, should be ==
#"coat"
