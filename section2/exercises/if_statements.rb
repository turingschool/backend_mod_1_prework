...
if num_quarters == 2
  ...
  puts "I could probably buy more than one gumball!"
end
...
if (cups_of_flour == 1) or (cups_of_flour == 5) or not has_sauce
  puts "I cannot make pizza"
elsif (cups_of_flour == 2 or cups_of_flour == 3) and has_sauce
