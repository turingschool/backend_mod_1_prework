...
#used rainy got umbrella, used night time got good to go.
  weather = 'night time'
...
#tried 1 quarter and output "I don't have enough money for a gumball", i put 2 and 4 and output "I have enough money for a gumball".
num_quarters = 4
