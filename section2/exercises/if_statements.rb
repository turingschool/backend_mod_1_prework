...
def pizza_ingredients(cups_of_flour, has_sauce)
...
pizza_ingredients(1, true)
pizza_ingredients(5, false)
pizza_ingredients(2, true)
pizza_ingredients(3, true)
