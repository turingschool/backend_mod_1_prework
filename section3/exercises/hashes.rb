...
email = {
  ...
  'subject' => "help, I don't know how to write an email!",
  'CCed?' => false,
  'BCC?' => true,
  'body' => "kahdkfhasdkfjhaskdjfhkjasdhf"
}
...
email = [
  ...
  {
    'Recipient' => 'BillyBob@aol.com',
    'Subject' => 'Come on dude',
    'CC' => false,
    'BCC' => false,
    'Body' => 'Dude, we are in the 2020s, stop using aol.'
  },
  {
    'Recipient' => 'BigBossMan@corporate.fear',
